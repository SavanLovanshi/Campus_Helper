...
const Electronics = ({ onNavigate, user }) => {
    ...
    const menuItems = [
        { name: "Digital Electronics", path: "/electronics/digital-electronics" },
        { name: "Analog Electronics", path: "/electronics/analog-electronics" },
        { name: "Signals and Systems", path: "/electronics/signal-systems" },
        { name: "Ask Doubts", path: "/ask-doubts" },
        // { name: "Electronics Calc", path: "/Electronics-calculator" },
    ...
    const features = [
        {
            id: "lab-manual",
            title: "Interactive Lab Manual",
            description:
                "Comprehensive guides for all Electronics experiments with step-by-step instructions and interactive diagrams.",
        ...
        {
            id: "Electronics-calculator",
            title: "Electronics Calculator",
            description:
                "Quickly solve complex Electronics equations with our specialized calculators for mechanics, electricity, thermodynamics and more.",
            icon: <Calculator className="w-6 h-6 text-white" />,
            color: "from-purple-500 to-purple-600",
            buttonText: "Use Calculator",
            path: "/Electronics-calculator",
        },
        {
            id: "ask-doubts",
            title: "Ask Doubts",
        ...
        {
            id: "bot",
            title: "Electronics Assistant Bot",
            description:
                "Get instant help from our AI-powered Electronics assistant that can answer questions and guide you through problems.",
    ...
    const stats = [
        ...
        { value: "1000+", label: "Electronics Formulas" },
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div className="space-y-8">
                            ...
                            <p className="text-lg text-gray-600 max-w-lg">
                                Experience Electronics like never before with our comprehensive
                            ...
                            <div className="relative space-y-6">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-500">
                                            Apply Electronics formulas easily
                                        </p>
                                    </div>
                                </div>
                ...
                <div className="max-w-6xl mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                            Everything You Need to Master Electronics
                        </h2>
                        <p className="text-gray-600 text-lg">
                            Our comprehensive platform provides all the tools you need to
                            understand and excel in Electronics through practical learning.
                        </p>
                    </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
                            <div className="p-12 lg:p-16">
                                <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
                                    Ready to Transform Your Electronics Learning Experience?
                                </h2>
                                <p className="text-white/90 text-lg mb-8">
                                    Join thousands of students who have improved their
                                    understanding of Electronics through our interactive platform.
                                </p>
                                <div className="flex flex-col sm:flex-row gap-4">
                                    <button
                ...
                <div className="max-w-6xl mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto">
                        <h2 className="text-3xl font-bold mb-4">
                            Stay Updated with Latest Electronics Resources
                        </h2>
