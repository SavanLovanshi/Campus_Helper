...
const Physics = ({ onNavigate, user }) => {
    ...
    const features = [
        {
            ...
            description:
                "Comprehensive guides for all physics experiments with step-by-step instructions and interactive diagrams.",
        ...
        
        {
            ...
            description:
                "Quickly solve complex physics equations with our specialized calculators for mechanics, electricity, thermodynamics and more.",
    ...
    const stats = [
        ...
        { value: "1000+", label: "Physics Formulas" },
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div className="space-y-8">
                            ...
                            <p className="text-lg text-gray-600 max-w-lg">
                                Experience physics like never before with our comprehensive
                ...
                <div className="max-w-6xl mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        ...
                        <p className="text-gray-600 text-lg">
                            ...
                            understand and excel in physics through practical learning.
                        </p>
                    </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
                            <div className="p-12 lg:p-16">
                                <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
                                    Ready to Transform Your Physics Learning Experience?
                                </h2>
                                <p className="text-white/90 text-lg mb-8">
                                    Join thousands of students who have improved their
                                    understanding of physics through our interactive platform.
                                </p>
                                <div className="flex flex-col sm:flex-row gap-4">
                                    <button
                ...
                <div className="max-w-6xl mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto">
                        <h2 className="text-3xl font-bold mb-4">
                            Stay Updated with Latest Physics Resources
                        </h2>
