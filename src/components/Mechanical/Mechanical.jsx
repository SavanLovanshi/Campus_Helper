...
const Mechanical = ({ onNavigate, user }) => {
    ...
    const menuItems = [
        { name: "Engineering Mechanics", path: "/mechanics/engineering-mechanics" },
        { name: "Thermodynamics", path: "/mechanics/thermodynamics" },
        { name: "Heat and Mass Transfer ", path: "/mechanics/heat-mass" },
    ...
    const features = [
        {
            ...
            description:
                "Comprehensive guides for all Mechanical experiments with step-by-step instructions and interactive diagrams.",
        ...
        },
        {
            ...
            description:
                "Quickly solve complex Mechanical equations with our specialized calculators for mechanics, electricity, thermodynamics and more.",
        ...
        {
            id: "bot",
            title: "Physics Assistant Bot",
            description:
                "Get instant help from our AI-powered physics assistant that can answer questions and guide you through problems.",
    ...
    const stats = [
        ...
        { value: "1000+", label: "Mechanical Formulas" },
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div className="space-y-8">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-100 text-orange-600 font-medium text-sm">
                                ...
                                Interactive Mechanical Learning
                            </div>

                            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight">
                                Master Mechanical Through{" "}
                            ...
                            <p className="text-lg text-gray-600 max-w-lg">
                                Experience Mechanical like never before with our comprehensive
                            ...
                            <div className="relative space-y-6">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-500">
                                            Apply Mechanical formulas easily
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="px-5 py-4 bg-white rounded-xl shadow border border-gray-100">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p className="font-medium">Thermodynamics Equation</p>
                ...
                <div className="max-w-6xl mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                            Everything You Need to Master Mechanical
                        </h2>
                        <p className="text-gray-600 text-lg">
                            Our comprehensive platform provides all the tools you need to
                            understand and excel in Mechanical through practical learning.
                        </p>
                    </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
                            <div className="p-12 lg:p-16">
                                <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
                                    Ready to Transform Your Mechanical Learning Experience?
                                </h2>
                                <p className="text-white/90 text-lg mb-8">
                                    Join thousands of students who have improved their
                                    understanding of Mechanical through our interactive platform.
                                </p>
                                <div className="flex flex-col sm:flex-row gap-4">
                                    <button
                ...
                <div className="max-w-6xl mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto">
                        <h2 className="text-3xl font-bold mb-4">
                            Stay Updated with Latest Mechanical Resources
                        </h2>
